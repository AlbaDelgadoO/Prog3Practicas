...
//		if(datos.get(0) instanceof String) {
...
//		}
		...
		GestionTwitter.agregarUsuarioID(u.getId(), u);
		GestionTwitter.agregarUsuarioNick(u.getScreenName(), u);
		VProgressBar.setProgressBar(numLin);
	}
	...
	private static ArrayList<String> getArrayListString(ArrayList<Object> datos, int index) {
	    if (index >= 0 && index < datos.size()) {
	        Object obj = datos.get(index);
